            ...
            >
              ...
              <div className="flex-1 flex items-center justify-center relative z-10">
                 <motion.div 
                    ...
                    className="w-44 h-44 rounded-full bg-v6-accent/[0.03] dark:bg-v6-accent/[0.05] blur-3xl group-hover:bg-v6-accent/10 transition-colors" 
                 />
                 <div className="absolute inset-0 flex items-center justify-center opacity-10 group-hover:opacity-30 transition-all duration-500 group-hover:scale-110">
                    <span className="text-[14px] font-black italic tracking-[0.6em] uppercase -rotate-90 origin-center">ARTIFACT_SECURED</span>
                 </div>
                 
                 {/* Decorative scanning line in card */}
                 <div className="absolute inset-x-10 h-px bg-v6-accent/20 opacity-0 group-hover:opacity-100 top-1/2 -translate-y-1/2 group-hover:animate-pulse" />
              </div>
              ...
              <div className="space-y-6 relative z-10">
                <div className="flex justify-between items-start gap-4">
                  ...
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      if (item.status !== 'SOLD OUT') addToCart(item);
                    }}
